...
execute if predicate {condition:"minecraft:random_chance",chance:{type:"minecraft:score",target:{type:"minecraft:fixed",name:"$probability"},score:"gm4_desire_lines",scale:0.01d}} at @s run function gm4_desire_lines:path
